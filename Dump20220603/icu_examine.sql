...
CREATE TABLE `examine` (
  ...
  KEY `Pid` (`Pid`),
  KEY `Did` (`Did`),
  CONSTRAINT `examine_ibfk_1` FOREIGN KEY (`Pid`) REFERENCES `patients` (`ID`),
  CONSTRAINT `examine_ibfk_2` FOREIGN KEY (`Did`) REFERENCES `doctors` (`ID`)
...
INSERT INTO `examine` VALUES (1,2,1);
