...
CREATE TABLE `relatives` (
  ...
  `nummber` int NOT NULL AUTO_INCREMENT,
  `SSn` int DEFAULT NULL,
  PRIMARY KEY (`nummber`),
  KEY `ID` (`ID`),
  CONSTRAINT `relatives_ibfk_1` FOREIGN KEY (`ID`) REFERENCES `patients` (`ID`)
...
INSERT INTO `relatives` VALUES (1,'Mahmoud',NULL,'Mahmoud','male',1,123456789);
