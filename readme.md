...
# <img align=center width=75px height=90px src="https://media3.giphy.com/media/5jh3rt2jAi9KMPSh9W/giphy.gif?cid=ecf05e47p22ox1l0buvbu0b6ar5jyqya29yf216tjk429wyp&rid=giphy.gif&ct=s"> ICU department in a hospital 
...
<ul> 
<li>
This is a project for making people able to know informations about their patients in the department and about their status .
</li>
<li >and also doctors ,nurses and administrator able to know their schedule </li>
<li>a lot of functions to be implemented like : add doctor ,nurses and patients etc... from administrator  </li>
</ul>
...
```
git clone https://github.com/Ms850446/icu_project.git
```

</li>
<li> you will need to download <a href="https://www.mysql.com/">mySql</a> </li>
<li> and setup it to be able to run the program </li>
...
```
after setup you will open server.py file and run the program "
```
</li>
<li>

```
the server link will appear and then you open it .
```
</li>
<li>
...
```
you can go to the log in page by clicking on the log in icon on the right of the header  
```
</li>
...
<ol>
<li>
patient can't create an account but his administrators can create an account and by it they can know his status and the available time to visit him  
</li>
<br>
<li>
doctor and nurses accounts can only be created by the administrator of the hospital and also he has the ability to delete their accounts 
</li>
<br>
</ol>
...
<table align="center" >
  <tr>
    ...
    <td align="center"><a href="https://github.com/mohamed33333"><img src="https://avatars.githubusercontent.com/u/85584384?v=4" width="150px;" alt=""/><br /><sub><b>Mohamed Nasser</b></sub></a><br /></td>
